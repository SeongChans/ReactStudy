...
var TOGGLE_SWITCH = 'TOGGLE-SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; //액션 타입 정의 *문자열 형태 주로 대문자 작성 이름은 고유해아함
...
render(); //render 함수 만들기 - 상태가 업데이트될 때마다 호출되며, 리액트의 render함수와는 다르게
//  이미 html을 사용하여 만들어진 UI의 속성을 상태에 따라 변경해줍니다.

store.subscribe(render); //구독하기 - 상태가 바뀔때마다 방금 만든 render 함수가 호출 됨
